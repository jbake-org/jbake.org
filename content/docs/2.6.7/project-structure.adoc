...
http://www.thymeleaf.org/doc/html/Using-Thymeleaf.html[Thymeleaf], https://github.com/neuland/jade4j[Jade] & https://pebbletemplates.io/wiki/guide/basic-usage/[Pebble].
